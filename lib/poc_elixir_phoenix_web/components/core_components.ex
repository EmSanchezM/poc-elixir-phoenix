defmodule PocElixirPhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PocElixirPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PocElixirPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
